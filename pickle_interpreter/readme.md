...
for inst in instructions:
    ...
    if opcode== "PROTO":
    ...
    elif opcode== "SHORT_BINUNICODE":
        stack.append(val.replace("'",""))

    elif opcode== "MEMOIZE":
        memo[par[2].replace(")","")] = stack[-1]
        ...
        stack.append(eval(par[2].replace("'","")))

    elif opcode== "STACK_GLOBAL":
        second = stack.pop()
        first = stack.pop()
        #print(first+"."+second)
        if first == "builtins": stack.append(eval(second))
            ...
            print('2')
            stack.append(eval(first+"."+second))
        ...
        if opcode== type(args[0]) == reversed: 
        ...
        elif opcode== (func.__qualname__ == "loads") and (len(stack) == 13):
        ...
        elif opcode== (func.__qualname__ == "bytes") and (len(stack) == 12): 
    ...
    elif opcode== "BINBYTES":
        va1=inst.split("BINBYTES   b'")[1][:-1]
        stack.append(va1.encode())
